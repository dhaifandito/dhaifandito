...
function Footer() {
  ...
  return (
    <footer className="py-6 bg-dark-primary mt-24 flex justify-center items-center flex-col">
      <div className="flex justify-between items-center w-3/4">
        <div className="lg:grid grid-cols-3 lg:grid-cols-4 w-full">
          ...
          <div className="flex lg:justify-center items-center">
            ...
            />
            <a
              href="https://www.instagram.com/dhaifandito12"
              target="_blank"
              rel="noopener noreferrer"
              className="mx-2 text-green-200 hover:text-dark-accenttext"
            >
              dhaifandito12
            </a>
          </div>
          <div className="flex lg:justify-center items-center">
            ...
            />
            <a
              href="https://www.linkedin.com/in/dhaifan-dito-adrian-202a5b1b7/"
              target="_blank"
              rel="noopener noreferrer"
              className="mx-2 text-green-200 hover:text-dark-accenttext"
            >
      ...
      <p className="p-12">
        &copy; 2024 Dhaifan Dito Adrian. All rights reserved.
      </p>
    </footer>
  );
}
